/datum/species/synthliz
	...
	mutant_bodyparts = list("ipc_antenna" = "Synthetic Lizard - Antennae","mam_tail" = "Synthetic Lizard", "mam_snouts" = "Synthetic Lizard - Snout", "legs" = "Plantigrade", "mam_body_markings" = "Synthetic Lizard - Plates")

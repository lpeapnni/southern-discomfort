/datum/species/xeno
	...
	mutant_bodyparts = list("xenotail"="Xenomorph Tail","xenohead"="Standard","xenodorsal"="Standard", "mam_body_markings" = list(),"mcolor" = "0F0","mcolor2" = "0F0","mcolor3" = "0F0", "legs" = "Digitigrade","deco_wings"= "None")
	attack_verb = "slash"
